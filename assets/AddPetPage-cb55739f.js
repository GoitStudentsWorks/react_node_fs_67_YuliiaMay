import{s as n,j as t,e as s,L as P,c as _,u as g,r as C,I as x,t as z,v as N,w as M,g as U,x as b,y as ee}from"./index-216a50c7.js";import{u as J}from"./formik.esm-0fa61da0.js";import{c as te,a as ne,b as oe}from"./bg-mob@1x-6113c5e2.js";const ie=n.div`
...
`,$e=()=>{const e=s(E);return t.jsxs(he,{children:[t.jsxs(ue,{children:[t.jsx(xe,{$formStage:e,children:"Choose  option"}),t.jsx(ge,{$formStage:e})]}),t.jsx(pe,{children:t.jsxs(fe,{$formStage:e,children:["Personal details",t.jsx(be,{$formStage:e})]})}),t.jsxs(ye,{children:[t.jsx(we,{$formStage:e,children:"More info"}),t.jsx(je,{$formStage:e})]})]})},Se=n.ul`
    display: flex;
    flex-direction: column;
...
`,R=n.span`
    ...
    font-size: 16px;
    margin-right: 12px;
`,I=({onClick:e})=>{var p;const i=s(E),o=_(),r=g(),a=C.useRef(((p=o.state)==null?void 0:p.from)??"/notices/sell");console.log(a.current);let l;const u=()=>{if(i===3||i===2)return l=i-1,l},k=()=>{r(z(u()))};return t.jsx(t.Fragment,{children:i!=="success"&&t.jsxs(ke,{children:[i===1?t.jsxs(v,{to:a.current,children:[t.jsx(x,{iconName:"icon-arrow-left",width:"24px",height:"24px",stroke:"#54ADFF"}),t.jsx(F,{children:"Cancel"})]}):t.jsxs(v,{onClick:k,children:[t.jsx(x,{iconName:"icon-arrow-left",width:"24px",height:"24px",stroke:"#54ADFF"}),t.jsx(F,{children:"Back"})]}),t.jsxs(Ce,{onClick:e,type:"submit",children:[i===3?t.jsx(R,{children:"Done"}):t.jsx(R,{children:"Next"}),t.jsx(x,{iconName:"icon-pawprint",width:"24px",height:"24px",fill:"#FEF9F9"})]})]})})},ve=({onLeavePage:e})=>{const i=g(),o=s(S),r=({target:{value:l}})=>{i(N({category:l}))},a=()=>{(o==="your pet"||o==="sell"||o==="lost/found"||o==="in good hands")&&i(z(2))};return t.jsxs(t.Fragment,{children:[t.jsxs(Se,{children:[t.jsx(y,{type:"button",value:"your pet",name:"your pet",onClick:r,$category:o}),t.jsx(y,{type:"button",value:"sell",name:"sell",onClick:r,$category:o}),t.jsx(y,{type:"button",value:"lost/found",name:"lost/found",onClick:r,$category:o}),t.jsx(y,{type:"button",value:"in good hands",name:"in good hands",onClick:r,$category:o})]}),t.jsx(I,{onClick:a,onLeavePage:e})]})},Fe=n.form`
    display: flex;
    flex-direction: column;
    align-items: center;
    margin-bottom: 40px;
...
`,Je=n.textarea`
    ...
    font-size: 16px;
    color: ${e=>e.theme.color.grey};  
`,A=()=>{const[e,i]=C.useState(null),[o,r]=C.useState(""),a=g(),l=s(S),u=s(ce),k=s(Q),p=s(X),V=s(ae),q=s(K),W=s(L),f=U(),h=J({initialValues:{imgUrl:o,comments:s(le)||"",location:s(de)||"",price:s(me)||""},onSubmit:d=>{console.log(d),a(b(d));const c=new FormData;for(let m in d)m!=="imgUrl"&&m!=="sell"?c.append(m,d[m]):m==="imgUrl"&&c.append("file",o);c.append("sex",u),c.append("category",l),c.append("name",k),c.append("birthday",p),c.append("breed",V),c.append("title",q),c.append("type",W);for(const[m,O]of c.entries())console.log(`${m}: ${O}`);a(ee(c)),H(),Z()}}),G=d=>{let c=d.target.files[0];r(c);const m=new FileReader;m.onloadend=()=>{i(m.result)},m.readAsDataURL(c)},T=({target:{value:d}})=>{if(d==="Male"){a(b({...A,sex:"male"}));return}if(d==="Female"){a(b({...A,sex:"female"}));return}},Z=()=>{l==="your pet"?f("/user"):l==="sell"?f("/notices/sell"):l==="lost/found"?f("/notices/lost-found"):l==="in good hands"&&f("/notices/for-free")},H=()=>{a(N({category:null}),M({name:"",birthday:"",breed:"",title:"",type:""}),b({sex:"",imgUrl:"",comments:"",location:"",price:""}))};return t.jsx(t.Fragment,{children:t.jsxs(Ee,{onSubmit:h.handleSubmit,encType:"multipart/form-data",children:[t.jsxs(Ie,{children:[t.jsxs(Te,{children:[(l==="sell"||"lost/found")&&t.jsxs(t.Fragment,{children:[t.jsx(Ye,{children:"The Sex"}),t.jsxs(De,{children:[t.jsxs(Y,{type:"button",value:"Female",name:"female",onClick:T,$sex:u,children:[t.jsx(x,{iconName:"icon-female",width:"24px",height:"24px",stroke:"#F43F5E"}),t.jsx(D,{children:"Female"})]}),t.jsxs(Y,{type:"button",value:"Male",name:"male",onClick:T,$sex:u,children:[t.jsx(x,{iconName:"icon-male",width:"24px",height:"24px",stroke:"#54ADFF"}),t.jsx(D,{children:"Male"})]})]})]}),t.jsxs($,{htmlFor:"imgUrl",children:["Load the pet’s image:",t.jsx(Ne,{children:e?t.jsx("div",{children:t.jsx(Me,{src:e,alt:"pet`s photo"})}):t.jsx("img",{src:ze,alt:"default avatar photo"})}),t.jsx(Be,{accept:"image/*",type:"file",name:"imgUrl",id:"imgUrl",onChange:d=>G(d)})]})]}),t.jsxs(Re,{children:[(l==="sell"||"lost/found")&&t.jsxs(t.Fragment,{children:[t.jsx($,{htmlFor:"location",children:"Location"}),t.jsx(B,{placeholder:"Type of location",type:"text",id:"location",name:"location",onChange:h.handleChange,value:h.values.location,required:!0})]}),l==="sell"&&t.jsxs(t.Fragment,{children:[t.jsx($,{htmlFor:"price",children:"Price"}),t.jsx(B,{placeholder:"Type of price",type:"text",id:"price",name:"price",onChange:h.handleChange,value:h.values.price,required:!0})]}),t.jsxs(Ue,{children:[t.jsx($,{htmlFor:"comment",children:"Comments"}),t.jsx(Je,{type:"text",id:"comment",placeholder:"Type of pet",name:"comments",onChange:h.handleChange,value:h.values.comments,required:!0})]})]})]}),t.jsx(I,{})]})})},Qe="/react_node_fs_67_YuliiaMay/assets/success-created-b8079584.png",Xe=n.div`
    height: 100%;
    display: flex;
    flex-direction: column;
    align-items: center;
...
`,Ke=n.img`
    width: 300px;
    height: 300px;
`,Le=({onLeavePage:e,onClick:i})=>(g(),t.jsxs(Xe,{children:[t.jsx(Ke,{src:Qe,alt:"success",width:300}),t.jsxs(v,{onLeavePage:e,children:[t.jsx(x,{iconName:"icon-arrow-left",width:"24px",height:"24px",stroke:"#54ADFF"}),t.jsx(F,{onClick:i,children:"Go Back"})]})]})),Ve=({onLeavePage:e})=>{const i=s(E),o=s(S),r=U();g();const a=()=>{o==="your pet"?r("/user"):o==="sell"?r("/notices/sell"):o==="lost/found"?r("/notices/lost-found"):o==="in good hands"&&r("/notices/for-free")};return t.jsxs(ie,{$stage:i,children:[t.jsx(se,{title:o===null&&"Add pet"||o==="your pet"&&"Add pet"||o==="sell"&&"Add pet for sell"||o==="lost/found"&&"Add lost pet"||o==="in good hands"&&"Add pet in good hands"||o==="success"&&"Your post has been created!"}),t.jsx($e,{}),i===1&&t.jsx(ve,{onLeavePage:e}),i===2&&t.jsx(Ae,{}),i===3&&t.jsx(A,{}),i==="success"&&t.jsx(Le,{onLeavePage:e,onClick:a})]})},qe="/react_node_fs_67_YuliiaMay/assets/bg-mob@2x-283a5e61.png",We="/react_node_fs_67_YuliiaMay/assets/bg-tab@2x-0903fd47.png",Ge="/react_node_fs_67_YuliiaMay/assets/bg-des@2x-5b99db9e.png",Ze=n.div`
