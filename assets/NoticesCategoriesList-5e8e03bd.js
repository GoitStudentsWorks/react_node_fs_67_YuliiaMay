...
`;function O({card:t,active:o,setShow:r,isFavorites:a,handleFollowAdd:l,handleFollowDel:p}){const[D,F]=i.useState(!1),$=b(E),[u,m]=i.useState(a);if(!t)return;const k=()=>{r(!1)};if(!t)return;const{imgUrl:v,name:j,birthday:x,breed:s,place:w,sex:y,email:C,phone:g,comments:h,title:S,category:B,price:M}=t,I=A=>{if(!$.token){F(!0);return}u?p(A):l(A),m(!u)},z=A=>A?e.jsxs(e.Fragment,{children:["Favorite",e.jsx(f,{iconName:"icon-heart-full",width:"24px",height:"24px",stroke:"#C5DFF6",fill:"#C5DFF6"})]}):e.jsxs(e.Fragment,{children:["Add to",e.jsx(f,{iconName:"icon-heart",width:"24px",height:"24px",stroke:"#ffffff",fill:"#ffffff"})]});return e.jsxs(e.Fragment,{children:[e.jsx(R,{onClose:r,active:o,children:e.jsxs($e,{children:[e.jsx(Ae,{onClick:k,children:e.jsx(f,{iconName:"icon-cross",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"})}),e.jsxs(Se,{children:[e.jsxs(Ie,{children:[e.jsx("span",{children:B}),e.jsx(Ne,{src:q(v),alt:"name image"})]}),e.jsxs(Me,{children:[e.jsx(Be,{children:S}),e.jsx(ze,{children:e.jsx("table",{children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("td",{children:"Name:"}),e.jsx("td",{children:e.jsx("span",{children:j})})]}),!M<=0&&e.jsxs("tr",{children:[e.jsx("td",{children:"Price:"}),e.jsx("td",{children:e.jsxs("span",{children:[M," ₿"]})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Birthday:"}),e.jsx("td",{children:e.jsx("span",{children:le(x)})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Type:"}),e.jsx("td",{children:e.jsx("span",{children:s})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Place:"}),e.jsx("td",{children:e.jsx("span",{children:w})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Sex:"}),e.jsx("td",{children:e.jsx("span",{children:y})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Email:"}),e.jsx("td",{children:e.jsx("a",{href:`mailto:${C}`,children:C})})]}),e.jsxs("tr",{children:[e.jsx("td",{children:"Phone:"}),e.jsx("td",{children:e.jsx("a",{href:`tel:${g}`,children:we(g)})})]})]})})})]})]}),e.jsxs(_e,{children:["Comments:",e.jsx("span",{children:h})]}),e.jsxs(Pe,{children:[e.jsx(Le,{onClick:()=>I(t._id),children:z(u)}),e.jsx(Ee,{href:`tel:${g}`,children:"Contact"})]})]})}),e.jsx(e.Fragment,{children:e.jsx(U,{active:D,setShow:F})})]})}O.propTypes={active:c.bool,isFavorites:c.bool,setShow:c.func,card:c.object,handleFollowAdd:c.func,handleFollowDel:c.func};const P=n.span`
  font-size: 12px;
  font-weight: 600;
